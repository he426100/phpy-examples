...
extract(import_from('modelscope.utils.config', 'Config'));
extract(import_from('modelscope.utils.constant', 'ModelFile'));
...
$train_dataset = $MsDataset->load( 'WIRD9090/ocr_plate', split: 'train');
$test_dataset = $MsDataset->load('WIRD9090/ocr_plate', split: 'validation');
